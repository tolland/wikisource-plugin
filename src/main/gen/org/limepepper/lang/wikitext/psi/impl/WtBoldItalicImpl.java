...
public class WtBoldItalicImpl extends ASTWrapperPsiElement implements WtBoldItalic {

  public WtBoldItalicImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtVisitor visitor) {
    visitor.visitBoldItalic(this);
  }
