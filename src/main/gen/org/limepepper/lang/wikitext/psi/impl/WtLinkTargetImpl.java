...
public class WtLinkTargetImpl extends ASTWrapperPsiElement implements WtLinkTarget {

  public WtLinkTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull WtVisitor visitor) {
    visitor.visitLinkTarget(this);
  }
